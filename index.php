            ...
            <div class="collapse navbar-collapse mr-auto text-center" id="navbarNavDropdown-3">
                <ul class="navbar-nav ml-auto ">
                    <li class="nav-item mx-2">
                        <a class="btn btn-outline-primary" href="https://github.com/kereons/clima">
                            <i class="fab fa-github"></i> GitHub
                        </a>
                    </li>
                    <li class="nav-item m-2 m-md-0">
                        <a class="btn btn-primary" href="https://github.com/kereons/clima/archive/master.zip">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <!--<form action="api.php" method="post">
                        <select name="ncity" id="ncity">
                            <option value="3667983">Sincelejo</option>
                            <option value="5095808">Bogota</option>
                            <option value="5304640">Miami</option>
                        </select>
                        <input type=submit>
                    </form>-->
                    <div class="btn-group" role="group" aria-label="Listas de ciudades">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="ciudades">
                                <a class="dropdown-item" href="#sincelejo">Sincelejo</a>
                                <a class="dropdown-item" href="#monteria">Monteria</a>
                                <a class="dropdown-item" href="#corozal">Corozal</a>
                            </div>
                        </div>
                    </div>
                </div>
